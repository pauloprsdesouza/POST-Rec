...
from apps.api.services.relevance_service import compute_relevance_score
from apps.api.services.vector_retrieval_service import vector_retrieval_service
from apps.api.settings import get_settings
from packages.postrec_core.retrieval.bm25 import bm25_score_paper
    ...
    def rerank_papers(
        ...
        *,
        ...
        for paper in papers:
            ...
            if settings.bm25_sparse_enabled:
