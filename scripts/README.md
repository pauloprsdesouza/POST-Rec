...
| `deploy_portainer.py`, `deploy_shared_infra.py`, `deploy_grafana.py` | Production service deploy |
...
| `seed_qualis.py`, `seed_qualis_hostinger.py`, `migrate_coolify_shared_db.py` | Data / infra |
